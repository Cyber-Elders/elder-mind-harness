...
- **Licensing** — `docs/LICENSING.md` recommendation (keep Apache-2.0 code + CC BY 4.0 docs for frictionless corporate adoption + patent grant), a `NOTICE` file, SPDX headers on all source files, and a DCO sign-off in CONTRIBUTING. Copyright standardized to © 2026 ZenBlue Pty Ltd t/a Cyber Elders (NOTICE / pyproject / README / PDFs).
