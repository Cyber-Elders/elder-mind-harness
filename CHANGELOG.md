...
- **Licensing** — `docs/LICENSING.md` recommendation (keep Apache-2.0 code + CC BY 4.0 docs for frictionless corporate adoption + patent grant), a `NOTICE` file, SPDX headers on all source files, and a DCO sign-off in CONTRIBUTING.
