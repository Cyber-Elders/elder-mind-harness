...
5. **Fix the methodology repo:** `Cyberelders/elder-mind` declares CC BY 4.0 but GitHub detects *no license* — commit an actual `LICENSE` file before any public flip (flagged in the GitHub audit).
